function h = meshviewm(c, v, varargin)
%
% MESHVIEWM plots a triangulated mesh in map axes.
%
...
p.v = v;
p = PatchCoords(p);
h = patchm([p.lat1'; p.lat2'; p.lat3'], [p.lon1'; p.lon2'; p.lon3'], 'facevertexcdata', color(:), 'facecolor', 'flat', 'edgecolor', 'none');
